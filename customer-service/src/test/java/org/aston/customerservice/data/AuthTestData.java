...
public class AuthTestData {
    ...
    public static final UserDetails USER_DETAILS = new CustomUserDetails(PHONE_NUMBER, CUSTOMER_ID, CUSTOMER_STATUS);

    public static String createToken(String phoneNumber, String secret, Long jwtExpiration) {
        Map<String, Object> claims = new HashMap<>();
        claims.put(HEADER_KEY_CUSTOMER_ID, CUSTOMER_ID);
        claims.put(HEADER_KEY_CUSTOMER_STATUS, CUSTOMER_STATUS);
        return Jwts.builder()
                .claims(claims)
                .subject(phoneNumber)
