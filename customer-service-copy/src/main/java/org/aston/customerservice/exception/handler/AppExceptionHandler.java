...
public class AppExceptionHandler {
    ...
    public ResponseEntity<String> handleGenericUserProfileNotFoundException(AuthorizationException exception) {
        log.error("Некорректные данные: {}", exception.getMessage());
        return ResponseEntity
                .status((exception.getStatus() != null) ? exception.getStatus() : HttpStatus.UNAUTHORIZED)
    ...
    @ExceptionHandler({CustomerRefreshTokenExpiredException.class})
    public ResponseEntity<String> handleGenericCustomerException(RuntimeException exception) {
    ...
    public ResponseEntity<String> handleGenericHttpMessageNotReadableExceptionException(HttpMessageNotReadableException exception) {
    ...
    public ResponseEntity<String> handleGenericHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException exception) {
        ...
        return ResponseEntity.status(HttpStatus.UNSUPPORTED_MEDIA_TYPE).body(UNSUPPORTED_CONTENT_TYPE);
    }
}
